...
#undef lu_kbra_gamebox_client_es_game_game_world_World_GEN_CIRCLE_SIZE
#define lu_kbra_gamebox_client_es_game_game_world_World_GEN_CIRCLE_SIZE 1L
...
#define lu_kbra_gamebox_client_es_game_game_world_World_EAT_DISTANCE 3.0f
