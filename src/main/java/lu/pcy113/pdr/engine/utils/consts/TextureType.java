...
public enum TextureType implements GLConstant {
	...
	TXT2DMS(GL40.GL_TEXTURE_2D_MULTISAMPLE, TXT2D),
	
	PROXYTXT1D(GL40.GL_PROXY_TEXTURE_1D, TXT1D), PROXYTXT2D(GL40.GL_PROXY_TEXTURE_2D, TXT2D), PROXYTXT3D(GL40.GL_PROXY_TEXTURE_3D, TXT3D),
	PROXYTXT2DMS(GL40.GL_PROXY_TEXTURE_2D_MULTISAMPLE, PROXYTXT2D),
	
	ARRAY1D(GL40.GL_TEXTURE_1D_ARRAY, TXT1D), ARRAY2D(GL40.GL_TEXTURE_2D_ARRAY, TXT2D),
	ARRAY2DMS(GL40.GL_TEXTURE_2D_MULTISAMPLE_ARRAY, ARRAY2D),
	
	PROXYARRAY1D(GL40.GL_PROXY_TEXTURE_1D_ARRAY, ARRAY1D), PROXYARRAY2D(GL40.GL_PROXY_TEXTURE_2D_ARRAY, ARRAY2D),
	PROXYARRAY2DMS(GL40.GL_PROXY_TEXTURE_2D_MULTISAMPLE_ARRAY, PROXYARRAY2D),
