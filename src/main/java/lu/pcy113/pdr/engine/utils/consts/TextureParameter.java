...
public enum TextureParameter implements GLConstant {
	...
	// Wrap
	WRAP_S(GL40.GL_TEXTURE_WRAP_S), WRAP_T(GL40.GL_TEXTURE_WRAP_T), WRAP_R(GL40.GL_TEXTURE_WRAP_R),
	WRAP_VERTICAL(GL40.GL_TEXTURE_WRAP_T), WRAP_HORIZONTAL(GL40.GL_TEXTURE_WRAP_S), WRAP_DEPTH(GL40.GL_TEXTURE_WRAP_R);
