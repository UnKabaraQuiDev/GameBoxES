...
public class UIntAttribArray
	...
	public void init() {
		...
		if (bufferType != GL40.GL_ELEMENT_ARRAY_BUFFER) GL40.glVertexAttribPointer(index, dataSize, GL40.GL_UNSIGNED_INT, false, 0, 0);
	}
	...
	public void update(int[] nPos) {
		if (!iStatic && nPos.length != data.length) return;
		data = nPos;
