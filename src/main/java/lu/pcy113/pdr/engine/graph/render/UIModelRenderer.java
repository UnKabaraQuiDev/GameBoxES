...
public class UIModelRenderer extends Renderer<Scene, UIModelComponent> {
	...
	@Override
	public void render(CacheManager cache, Scene scene, UIModelComponent co) {
		UIModel c = co.getUIModel(cache);
		if (c == null) return;

		GlobalLogger.log(Level.INFO, "UIModel : " + c.getId());
