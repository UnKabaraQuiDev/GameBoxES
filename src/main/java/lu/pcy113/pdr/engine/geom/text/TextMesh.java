...
public class TextMesh
	...
	public TextMesh(int size) {
		super(NAME + "_" + size, null, new Vec3fAttribArray("pos", 0, 1, new Vector3f[size * 4], false),
				new UIntAttribArray("ind", -1, 1, PDRUtils.intCountingUpTriQuads(size)),
				new UIntAttribArray("index", 1, 1, PDRUtils.intCountingUp(0, size, 1, 4)), new Vec2fAttribArray("uv", 2, 1, PDRUtils
						.vec2Repeating(new Vector2f[] {new Vector2f(0, 1), new Vector2f(1, 1), new Vector2f(1, 0), new Vector2f(0, 0)}, size)));
