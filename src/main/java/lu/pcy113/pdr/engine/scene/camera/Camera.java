...
public abstract class Camera {
	...
	public static final Camera3D perspectiveCamera3D() {
		return new Camera3D(
				new Vector3f(0), 
				new Quaternionf().identity().rotateTo(new Vector3f(-1, 0, 0), new Vector3f(1, 0, 0)),//.lookAlong(GameEngine.FORWARD.x, GameEngine.FORWARD.y, GameEngine.FORWARD.z, GameEngine.UP.x, GameEngine.UP.y, GameEngine.UP.z).rotateZ((float) Math.PI),
